...
//Load all the products from the products.json to an array
...
function addCards(initialRange, finalRange, container) {
  for (let i = initialRange; i <= finalRange; i++) {
    ...
    cardImage.alt = "Snowboard product";
...
function addCardsToCarousel(initialRange, finalRange, container) {
  ...
  card.innerHTML = `
                        <div class="card" >
                            <img src="${products[i].img}" class="card-img-top" alt="Snowboard product">
